...
<?php if (!$ajax) { ?>
  ...
  <div id="energyplus-comments-2" >
    ...
    <div class="__A__Searching_In">
      <input type="text" class="form-control __A__Search_Input" placeholder="<?php esc_html_e('Search in comments...', 'energyplus'); ?>" value="<?php echo esc_attr(EnergyPlus_Helpers::get('s'));  ?>"></span>
    </div>
  </div>
