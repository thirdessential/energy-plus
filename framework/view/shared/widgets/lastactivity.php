            ...
            <div class="__A__I_Overflow">
              <?php foreach ($session['views'] AS $views_key => $r) { ?>
                <div class="__A__I_O_Container">
                  ...
                  <?php } elseif (2 === $r['type']) {  ?>
                    <div class="__A__Widget_Lastactivity_T2"  data-toggle="tooltip" data-placement="bottom" title="<?php echo esc_html($r['details']['name'])?>"><?php echo esc_html($r['details']['name'])?></div>
                  <?php } elseif (4 === $r['type']) {  ?>
                  ...
                  <?php } elseif (17 === $r['type']) {  ?>
                    <div class="__A__Widget_Lastactivity_T2"  data-toggle="tooltip" data-placement="bottom" title="<?php echo esc_html($r['details']['term'])?>"><?php echo esc_html($r['details']['term'])?></div>
                  <?php } ?>
