    ...
    <div class="__A__Searching<?php if ('' === EnergyPlus_Helpers::get('s', '')) echo" closed"; ?>">
      ...
      <div class="row">
        ...
        <div class="col-12 col-lg-<?php if (!$ajax && '' === EnergyPlus_Helpers::get('s', '')) { echo '9'; } else { echo '12'; } ?> __A__Right">
          ...
          <?php } else {  ?>
            ...
            <?php } elseif ('pending' === EnergyPlus_Helpers::get('status')) {  ?>
              <h4 class='__A__Cat_Title'><?php esc_html_e('Pending Review', 'energyplus'); ?></h4>
            <?php } else {  ?>
                    ...
                    <div class="liste  row d-flex align-items-center">
                      ...
                      <?php if ('variant' !== $product['type']) {   ?>
                        ...
                        <div class="__A__Col_Title col-6 col-sm-3 align-middle">
                          ...
                          <?php echo esc_html($product['title']) ?> <?php if ('publish' !== $product['status'] && !EnergyPlus_Helpers::get('status')) { ?> &nbsp; <span class="badge badge-secondary text-uppercase"><?php echo esc_html($product['status'])?></span><?php } ?>
      ...
      <div class="col-lg-3 __A__Channels <?php if ('' !== EnergyPlus_Helpers::get('s', '')) echo" hidden"; ?>">
        <ul class="__A__General">
          ...
          <?php if (0 < $critical_stock) {  ?><li><span class="__A__Info"><a href="<?php echo EnergyPlus_Helpers::admin_page('products', array( 'category' => '-1' ));  ?>"><?php esc_html_e('Critical Stocks', 'energyplus'); ?> <span class="badge badge-pill badge-danger"><?php echo esc_html($critical_stock) ?></span></a></span></li><?php } ?>
          <?php if (0 < $outof_stock) {  ?><li><span class="__A__Info"><a href="<?php echo EnergyPlus_Helpers::admin_page('products', array( 'category' => '-2' ));  ?>"><?php esc_html_e('Out of Stocks', 'energyplus'); ?> <span class="badge badge-pill badge-danger"><?php echo esc_html($outof_stock) ?></span></a></span></li><?php } ?>
          <?php if (0 < $on_sales) {  ?><li><span class="__A__Info"><a href="<?php echo EnergyPlus_Helpers::admin_page('products', array( 'category' => '-4' ));  ?>"><?php esc_html_e('Sales', 'energyplus'); ?> <span class="badge badge-pill badge-danger"><?php echo esc_html($on_sales) ?></span></a></span></li><?php } ?>
          <?php if (0 < wp_count_posts('product')->private) {  ?><li><span class="__A__Info"><a href="<?php echo EnergyPlus_Helpers::admin_page('products', array( 'status' => 'private' ));  ?>"><?php esc_html_e('Private', 'energyplus'); ?> <span class="badge badge-pill badge-danger"><?php echo esc_html(wp_count_posts('product')->private) ?></a></span></li></span><?php } ?>
          <?php if (0 < wp_count_posts('product')->draft) {  ?><li><span class="__A__Info"><a href="<?php echo EnergyPlus_Helpers::admin_page('products', array( 'status' => 'draft' ));  ?>"><?php esc_html_e('Draft', 'energyplus'); ?> <span class="badge badge-pill badge-danger"><?php echo esc_html(wp_count_posts('product')->draft) ?></span></a></span></li><?php } ?>
          <?php if (0 < wp_count_posts('product')->pending) {  ?><li><span class="__A__Info"><a href="<?php echo EnergyPlus_Helpers::admin_page('products', array( 'status' => 'pending' ));  ?>"><?php esc_html_e('Pending', 'energyplus'); ?> <span class="badge badge-pill badge-danger"><?php echo esc_html(wp_count_posts('product')->pending) ?></span></a></span></li><?php } ?>
