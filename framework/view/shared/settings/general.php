                ...
                <div class="row">
                  ...
                  <div class="col-lg-8 __A__Description">
                    ...
                    <div class="col-lg-4 input-group __A__Settings_NCT">
                      ...
                      <input class="__A__Settings_Input form-control" data-segment='settings' data-section='features' data-feature='refresh'  placeholder="<?php esc_attr_e('N/A', 'energyplus'); ?>" value='<?php echo esc_attr(EnergyPlus::option('feature-refresh', '30')) ?>'/>
