  ...
  */
  ...
  public static function init() {
    ...
    if ( "1" === EnergyPlus::option('feature-own_themes')) {
      ...
      if ( !EnergyPlus::$theme ) {
        EnergyPlus::$theme = EnergyPlus::option('theme', 'one-shadow');
      }
    ...
    public static function styles() {
      ...
      if ((self::is_full()) OR (!self::is_full() && self::is_energyplus())) {
        ...
        $colors_css = ":root{";
          ...
          $JSvars['refresh']                         = absint(EnergyPlus::option('feature-refresh', 30))*1000;
      ...
      */
      ...
      public static function admin_head() {
        ...
        if (self!==top && window.parent.EnergyPlus_Window != null && window.parent.EnergyPlus_Window != undefined) {
          ...
          .woocommerce-embed-page:not(.edit-tags-php) #wpbody .woocommerce-layout, .woocommerce-embed-page:not(.edit-tags-php) .woocommerce-layout__notice-list-hide+.wrap { padding-top:5px !important; height:5px !important; } \
