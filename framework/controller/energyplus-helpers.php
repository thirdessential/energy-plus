...
class EnergyPlus_Helpers extends EnergyPlus {
  ...
  */
  ...
  public static function grouped_time ($date)  {
    ...
    if (intval(EnergyPlus_Helpers::strtotime('now', 'Ymd')) === intval(EnergyPlus_Helpers::strtotime($date, 'Ymd'))) {
      return array('key'=>'d'.EnergyPlus_Helpers::strtotime($date, 'z'), 'title'=>esc_html__('Today', 'energyplus'));
    }

    if ((intval(EnergyPlus_Helpers::strtotime('now', 'Y')) === intval(EnergyPlus_Helpers::strtotime($date, 'Y'))) && (intval((EnergyPlus_Helpers::strtotime('now', 'z')-1)) === intval(EnergyPlus_Helpers::strtotime($date, 'z')))) {
